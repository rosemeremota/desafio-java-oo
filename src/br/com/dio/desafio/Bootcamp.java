...
public class Bootcamp {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((devesInscritos == null) ? 0 : devesInscritos.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (dataFinal == null) {
            ...
            return false;
        if (devesInscritos == null) {
            if (other.devesInscritos != null)
                return false;
        } else if (!devesInscritos.equals(other.devesInscritos))
            return false;
        if (conteudos == null) {
    ...
    public String toString() {
        return "Bootcamp [nome=" + nome + ", descricao=" + descricao + ", dataInicial=" + dataInicial + ", dataFinal="
                + dataFinal + ", devesInscritos=" + devesInscritos + ", conteudos=" + conteudos + "]";
    }
